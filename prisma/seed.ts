...
const AUTOMATIONS = [
  ...
  { name: "Deal won", description: "When a deal is won, tell Finance to invoice. The setup task and install project are created by HQ itself.", trigger: { type: "deal.stage_changed", to: "won" }, actions: [{ type: "notify_department", department: "finance", title: "Deal won, invoice when ready" }] },
